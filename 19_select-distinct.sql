...
select distinct (product_name) -- view different product name
from products 
order by product_name 

select product_category, count(distinct product_name) -- view different product category and count of their respective product
from products 
