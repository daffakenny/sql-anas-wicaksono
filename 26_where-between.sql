...
-- varchar/text filtering
select *
from employee_data ed 
where full_name between 'a' and 'k' -- between a-j
order by full_name 



-- date filtering
select full_name , job_role , join_date 
from employee_data ed 
where join_date between '2015-01-01' and '2020-12-13'
order by join_date 
...
select *
from employee_data ed 
where salary between 48000 and 55000 -- between or equal to 48k - 55k
order by salary 
...
select *
from employee_data ed 
where last_promotion_date between '2019-01-01 00:00:00' and '2023-12-31 23:59:59'
